...
function enviarMensagemTelegram($mensagem, $email) {
    ...
    $telegramBotToken = 'AQUI_O_TOKEN_DO_BOT'; 
    $telegramChatID = 'ID_DO_SEU_USUARIO_OU_GRUPO';
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'meuemail@outlook.com'; // SEU EMAIL AQUI VEI PELA MOR DE DEUS 
    $mail->Password = 'minhasenhaaqui'; // SENHA DO SEU EMAIL MANO
    $mail->SMTPSecure = 'tls';
